...
namespace RehabConnectWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever]
            public IEnumerable<SelectListItem> CustomerSupportList { get; set; }
        }


        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!_roleManager.RoleExistsAsync(SD.Role_Parent).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(SD.Role_CustomerSupport)).GetAwaiter().GetResult();
            ...
            Input = new() {
                ...
                TherapistList = _unitOfWork.Therapist.GetAll().Select(i => new SelectListItem
                {
                    Text = i.TherapistName,
                    Value = i.TherapistID.ToString()
                }),
                CustomerSupportList = _unitOfWork.CustomerSupport.GetAll().Select(i => new SelectListItem
                {
                    Text = i.CSName,
                    Value = i.CSID.ToString()
                })
            };
