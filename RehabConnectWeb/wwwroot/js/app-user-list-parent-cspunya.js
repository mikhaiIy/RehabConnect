...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ajax: { url: '/customersupport/parentdetail/getall' },
      columns: [
        ...
        { data: 'householdIncome' },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/customersupport/parentdetail/upsert?parentID=' + data + '" class="text-body"><i class="ti ti-edit ti-sm me-2"></i></a>' +
      ...
      buttons: [
        ...
        },
        {
          ...
          attr: {
            onclick: 'window.location.href="/customersupport/parentdetail/upsert"'
          }
        }
      ],
  ...
  $('.datatables-users tbody').on('click', '.delete-record', function () {
    ...
    if (confirm("Are you sure you want to delete this record?")) {
      $.ajax({
        url: '/customersupport/parentdetail/delete/' + parentID,
        type: 'DELETE',
