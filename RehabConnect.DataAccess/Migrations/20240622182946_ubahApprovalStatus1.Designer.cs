...
namespace RehabConnect.DataAccess.Migrations
{
    ...
    [Migration("20240622182946_ubahApprovalStatus1")]
    partial class ubahApprovalStatus1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RehabConnect.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InvoiceID = 1,
                            DateIssued = new DateTime(2024, 6, 23, 2, 29, 45, 788, DateTimeKind.Local).AddTicks(2872),
                            ParentID = 1,
                            TotalAmount = 1000m
                        });
                });
            ...
            modelBuilder.Entity("RehabConnect.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CopyTriangle = false,
                            Crawling = false,
                            DateReport = new DateTime(2024, 6, 23, 2, 29, 45, 788, DateTimeKind.Local).AddTicks(2808),
