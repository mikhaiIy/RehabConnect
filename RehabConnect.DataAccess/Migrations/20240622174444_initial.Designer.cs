...
namespace RehabConnect.DataAccess.Migrations
{
    ...
    [Migration("20240622174444_initial")]
            ...
            modelBuilder.Entity("RehabConnect.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InvoiceID = 1,
                            DateIssued = new DateTime(2024, 6, 23, 1, 44, 44, 109, DateTimeKind.Local).AddTicks(2022),
                            ParentID = 1,
                            TotalAmount = 1000m
                        });
                });
            ...
            modelBuilder.Entity("RehabConnect.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CopyTriangle = false,
                            Crawling = false,
                            DateReport = new DateTime(2024, 6, 23, 1, 44, 44, 109, DateTimeKind.Local).AddTicks(1958),
