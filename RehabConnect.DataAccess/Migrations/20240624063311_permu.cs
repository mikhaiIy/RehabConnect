...
{
    /// <inheritdoc />
    public partial class permu : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Billings_ParentDetails_ParentDetailParentID",
                        column: x => x.ParentDetailParentID,
                        principalTable: "ParentDetails",
                        principalColumn: "ParentID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Olfactory = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPrograms", x => x.StudentProgramId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_CustomerSupports_CustomerSupportCSID",
                        column: x => x.CustomerSupportCSID,
                        principalTable: "CustomerSupports",
                        principalColumn: "CSID");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessions_StudentPrograms_StudentProgramId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St", "City", "Country", "john.doe@example.com", "A1234567", "John Doe", "Occupation", "123456789", "12345", "Race", null, "50000", "123 Main St", "City", "Country", "jane.doe@example.com", "B7654321", "Jane Doe", "Occupation", "987654321", "12345", "Race", null, null },
                    { 2, "123 Main St", "City", "Country", "Homelander.doe@example.com", "A1234567", "Homelander", "Occupation", "123456789", "12345", "Race", null, "50000", "123 Main St", "City", "Country", "Deep.doe@example.com", "B7654321", "Deep", "Occupation", "987654321", "12345", "Race", null, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Programs",
                columns: new[] { "ProgramID", "NumOfSession", "PriceWeekday", "PriceWeekend", "ProgramName", "StepId" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Billings_ParentDetailParentID",
                table: "Billings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_CustomerSupportCSID",
                table: "Sessions",
                column: "CustomerSupportCSID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_StudentProgramId",
                table: "Sessions",
