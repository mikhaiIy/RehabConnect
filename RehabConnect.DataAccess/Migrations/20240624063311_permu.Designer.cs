...
namespace RehabConnect.DataAccess.Migrations
{
    ...
    [Migration("20240624063311_permu")]
    partial class permu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RehabConnect.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InvoiceID = 1,
                            DateIssued = new DateTime(2024, 6, 24, 14, 33, 10, 699, DateTimeKind.Local).AddTicks(5139),
            ...
            modelBuilder.Entity("RehabConnect.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CopyTriangle = false,
                            Crawling = false,
                            DateReport = new DateTime(2024, 6, 24, 14, 33, 10, 699, DateTimeKind.Local).AddTicks(5107),
